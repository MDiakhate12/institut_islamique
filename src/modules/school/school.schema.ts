...
export const updateSchoolSettingsSchema = z.object({
  ...
  paymentPeriodShowTrimesters: z.boolean().optional(),
  paymentPeriodShowAnnually:   z.boolean().optional(),
  paymentPeriodShowMonthly:    z.boolean().optional(),
  paymentPeriodShowCantAfford: z.boolean().optional(),
  paymentMonths:               z.array(z.string()).optional(),
