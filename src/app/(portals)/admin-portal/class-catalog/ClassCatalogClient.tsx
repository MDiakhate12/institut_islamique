...
export function ClassCatalogClient() {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <ClassCatalogFormDialog allClasses={classes ?? []} />
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <CardsView groups={groups} allClasses={classes ?? []} />
      ) : (
        <GraphView groups={groups} allClasses={classes ?? []} />
      )}
    </div>
  )
}
        ...
        return (
          <section key={subjectCode}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {items.map(c => (
                <CatalogCard key={c.id} catalogClass={c} allClasses={allClasses} />
              ))}
            </div>
          </section>
        )
